...
switch(task) {
    ...
    case 'init': //Initiate - Needs to be done at the very beginning
        _cleanmem = external_define(dll,"halo_shg_clean",dll_cdecl,ty_real,0);
        _cleanmem_get_mem = external_define(dll,"halo_shg_get_mem",dll_cdecl,ty_real,0);
        return 0;
        exit;
